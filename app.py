    ...
    fig.add_trace(
        go.Bar(
            ...
            hovertemplate=(
                "<b>Week %{x}</b><br>"
                "Avg Return: %{y:.2f}%<br>"
                "Median Return: %{customdata[1]:.2f}%<br>"
                "Win Rate: %{customdata[2]:.1f}%<br>"
                "Volatility: %{customdata[3]:.2f}%<br>"
                "Max Gain: %{customdata[4]:.2f}%<br>"
                "Max Drawdown: %{customdata[5]:.2f}%<br>"
                "Sample size: %{customdata[6]}yrs"
                "<extra></extra>"
            ),
